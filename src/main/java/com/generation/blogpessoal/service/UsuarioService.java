...
public class UsuarioService 
{
	...
	na estrutura original, o senhaencoder receberá a senha criptografada (a criptografia ocorre no enconder), 
	e retornará a senha criptografada.
	 */
	...
	//Responsável por gerar o token através de uma codificação aleatória com junção de email e senha.
